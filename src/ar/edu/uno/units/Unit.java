...
public abstract class Unit {
	...
	public Unit(Double life, Double damage, Integer distanceMinToAttak,Integer distanceToAttack, Integer coordanateX, Integer coordanateY, Integer maxMovsInX, Integer maxMovsInY){
	 ...
	 * @return
	 * 
	 * <code>true</code> if the distance to the other unit is within the minimum and maximum range of attack.
	 * And also, this unit is alive;
	 ...
	 * @param unit
	 * @return
	 * Using {@link Math} calculates distance to other unit.
	 */
	 ...
	 * @return
	 * <code>true</code> if and only if @life > 0 
	 * <code>false</code> if @life <= 0.
	 */
	...
	/**
	 * This method set positionX and positionY.
	 * Before moving to the unit, valid not to exceed the maximum number of movements
	 * @param moveX
	 * @param moveY
	 */
	...
	/**
	 * @param distanceToAttack the distanceToAttack to set
	 */
	...
	/**
	 * @param coordanateX the coordanateX to set
	 */
	...
	/**
	 * @param coordanateY the coordanateY to set
	 */
	...
	/**
	 * @param distanceMinToAttak the distanceMinToAttak to set
	 */
	...
	/**
	 * @param maxMovsInX the maxMovsInX to set
	 */
	...
	/**
	 * @param maxMovsInY the maxMovsInY to set
	 */
